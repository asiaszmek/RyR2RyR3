...
ca_conc_file = "../datasets_for_fitting/ryr3_cam_po.csv"
ryr_op_fname = "../datasets_for_fitting/ryr3_cam_to.csv"
ryr_cl_fname = "../datasets_for_fitting/ryr3_cam_tc.csv"
...
<SDRun xmlns:xi="http://www.w3.org/2001/XInclude" xmlns="http://stochdiff.textensor.org">
    <xi:include href="Rxn_module_RyR_KeizerSmith.xml" />
...
if __name__ == "__main__":
    ...
    ax[0].set_xscale('log')
    ax[0].plot(exp_res[:, 0], exp_res[:, 1], "d",
    ...
    ax[0].set_ylabel("CaM-bound RyR3 open probability", fontsize=20)
