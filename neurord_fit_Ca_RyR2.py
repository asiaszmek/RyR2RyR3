...
params = aju.optimize.ParamSet(
    ...
    P('CaRyR_binding_bkw_rate', 0, fixed="CaRyR_binding_fwd_rate",
      constant=1000,		
      xpath='//Reaction[@id="RyRCabinding"]/reverseRate'),
    P('3CaRyR4_Ca_binding_fwd_rate', 0, fixed='CaRyR_binding_fwd_rate',
      constant=1,
      xpath='//Reaction[@id="RyRh"]/forwardRate'),
    P('3CaRyR4_Ca_binding_bkw_rate', 0, fixed='CaRyR_binding_fwd_rate',
      constant=1000,
    ...
    P('2CaRyR4_Ca_binding_bkw_rate', 0, fixed='CaRyR_binding_fwd_rate',
      constant=1000,
    ...
    P('CaRyR4_Ca_binding_bkw_rate', 0, fixed='CaRyR_binding_fwd_rate',
      constant=10000,
    ...
    P('Ca2RyR2_2RyR_binding_bkw_rate', 0, fixed='3Ca3RyR_RyRbinding_fwd_rate',
      constant=0.1,
    ...
    P('1CaRyRbinding_bkw_rate', 0, fixed= '3Ca3RyR_RyRbinding_fwd_rate',
      constant=0.1,
      xpath='//Reaction[@id="RyRa2"]/reverseRate'),
    P('4CaRyRbinding_bkw_rate', 0, fixed= '3Ca3RyR_RyRbinding_fwd_rate',
      constant=0.1,
