...
params = aju.optimize.ParamSet(P('Ca3RyR4_flicker_fwd_rate', 1e-3, min=1e-3, max=100, xpath='//Reaction[@id="RyRb"]/forwardRate'),
                               P('Ca4RyR4_fwd_rate', 1e-3, min=1e-3, max=100, xpath='//Reaction[@id="RyRd"]/forwardRate'),
                               P('3CaRyRbinding_fwd_rate', 1e-3, min=1e-6, max=1, xpath='//Reaction[@id="RyRa"]/forwardRate'),
                                P('4CaRyRbinding_fwd_rate', 1e-3, min=1e-6, max=1, xpath='//Reaction[@id="RyRc"]/forwardRate'))
