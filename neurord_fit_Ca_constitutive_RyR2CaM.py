...
dirname='fit_constitutive_RyR2CaM_Ca/'  #where data and model file are stored.  Can be different than current directory. Multiple datafiles allowed
...
params = aju.optimize.ParamSet(
    P('RyRCa1_fwd_rate', 0.001163, min=1e-7, max=1,
    ...
    P('Ca4RyR4_open_fwd_rate', 60.358, min=1e-3, max=1000,
      xpath='//Reaction[@id="RyRd"]/forwardRate'),
    P('Ca4RyR4_open_bkw_rate', 7.798,  min=1e-3, max=1000,
      xpath='//Reaction[@id="RyRd"]/reverseRate'),
    
    P('O1_flicker_fwd_rate', 0.0042 , min=1e-6, max=1000,
      xpath='//Reaction[@id="RyRf"]/forwardRate'),
    P('O1_flicker_bkw_rate', 0.563, min=1e-3, max=1000,
    ...
    P('O2_I_flicker_fwd_rate', 28.92, min=1, max=1000,

      xpath='//Reaction[@id="RyRh"]/forwardRate'),
    P('O2_I_flicker_bkw_rate', 0.1245, min=1e-3, max=1,
