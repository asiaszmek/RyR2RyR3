...
fname = "Rxn_module_RyR2_CaM_oxy.xml"
#  These are data from RyR2
#  2*Kd of RyR for CaM https://doi.org/10.1016/j.yjmcc.2015.06.009
#  by increasing reverse rates by 2
...
kfs = {"CaM": 2.1e-8, # for Kd of 820 nM (Xu and Meissner 2004 for RyR2)
       ...
       "CaMRyR2Ca4O1C1": 0.16,
       "CaMRyR2Ca4O2": 5.21e-2, "CaMRyR2Ca4O2C1":0.16e2,
       "CaMRyR2Ca4C1I": 4.37}
