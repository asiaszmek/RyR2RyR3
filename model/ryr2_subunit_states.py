...
kfs = {"CaM": 2.1e-8, # for Kd of 820 nM (Xu and Meissner 2004 for RyR2)
       ...
       "CaMRyR2Ca4O1C1": 0.16,
       "CaMRyR2Ca4O2": 5.21e-3, "CaMRyR2Ca4O2C1":0.16e3, "CaMRyR2Ca4C1I": 4.37}
...
krs = {"CaM": 1.73e-5, "CaMCa2C": 3.67e-6, "CaMCa4": 1.28e-6,
       ...
       "CaMRyR2Ca4O1": 8.08,"CaMRyR2Ca4O1C1": 32, "CaMRyR2Ca4O2": 8.08e-3,
       "CaMRyR2Ca4O2C1": 32e3,  "CaMRyR2Ca4C1I":0.95}
counter = 1
    ...
    for i, specie in enumerate(ryr_species_to_open):
        if "CaM" not in specie:
            ...
            add_reaction(my_rxn_file, specie, "RyR2Ca4O2",
                         "%s_O2"%specie)
            add_reaction(my_rxn_file, "%s_O1" % specie,"RyR2Ca4O2C1",
                         "%s_C1"%specie)
            ...
            add_reaction(my_rxn_file, specie, "CaMRyR2Ca4O2",
                         "%s_O2"%specie)
            add_reaction(my_rxn_file, "%s_O1" % specie,"CaMRyR2Ca4O2C1",
                         "%s_C1"%specie)
